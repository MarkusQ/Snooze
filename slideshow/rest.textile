...
!={height:90%}artists.jpg!

{{ gradient lightblue aqua lightgreen aqua  }}

h1(hidden). 2

!={height:90%}artists2.jpg!

{{ gradient lightblue aqua lightgreen aqua  }}

h1(hidden). 3

!={height:90%}artists3.jpg!
...
h1(fullscreen). Hold on a second...that's it?

{{ gradient silver white silver white }}



h1. Culture interlude (Cyrano de Bergerac, by Edmund Rostand)

*DE GUICHE* This fellow grows tiresome Will no one put him in his place? 

*VALVERT* _(a toady to de Guiche)_ Observe! I myself will proceed To put him in his place 
_(Walking up to Cyrano)_ Ah your nose... ahem...Your nose is...rather large! 

*CYRANO* Is that all? 

*VALVERT* _(turning away contemptuously)_ Oh, well... 

*CYRANO* Ah, no, young sir!  You are too simple. Why, you might have said...oh, a great many things! Mon dieu, why waste your opportunity? 
...
A turring complete programming paradigm, on equal footing with procedural, OOP, FP, JSOP, AESOP, SOP, AOP, etc.
...
|_. REST-Speak |_. Examples  |
| Verbs        | &rArr; HTTP(HyperText Transfer Protocol) GET, POST, PUT, DELETE |
| Nouns        | &rArr; "Numbers":http://localhost:2222/class/number, "Strings":http://localhost:2222/class/string, "Arrays":http://localhost:2222/class/array, "Lambdas":http://localhost:2222/class/lambda, "Classes":http://localhost:2222/class/class, "Graphs":http://Neo4j.org/, etc. |
| Types        | &rArr; HTML(HyperText Markup Language), RSS(Really Simple Syndication), PNG(Portable Network Graphics), etcetera |
